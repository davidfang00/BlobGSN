# From Bill Peebles, thanks Bill!
# https://raw.githubusercontent.com/wpeebles/gangealing/739da2a25de62702d54d83fad6b644646512039c/utils/distributed.py
import torch
...
def all_gatherv(input, return_boundaries=False):
    ...
    if difference > 0:
        input = torch.cat([input, torch.zeros(difference, *input.size()[1:], device=input.device, dtype=input.dtype)],
                          0)
